...
namespace UdpController
{
    public class DeviceInput : MonoBehaviour
    {
        ...
        private void FixedUpdate()
        {
            ...
            // 符号をなくすため、0~100に変換する
            var leftPadX = _customActions.UI.LeftStickX.ReadValue<float>() * 50 + 50;
            var leftPadY = _customActions.UI.LeftStickY.ReadValue<float>() * 50 + 50;
            var rightPadX = _customActions.UI.RightStickX.ReadValue<float>() * 50 + 50;
            var rightPadY = _customActions.UI.RightStickY.ReadValue<float>() * 50 + 50;
            ...
            uint8Arr[5] = (byte)(int)leftPadX;
            uint8Arr[6] = (byte)(int)leftPadY;
            uint8Arr[7] = (byte)(int)rightPadX;
            uint8Arr[8] = (byte)(int)rightPadY;
